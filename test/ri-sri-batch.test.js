 ...
 *
 * 2026-09-06: ACP 경로에서는 뺐다(남은 일 §5.3) — CIN 은 acpi 가 없으므로 CIN 아닌 행
 * 34,494개를 전수 확인해 sri 형 항목 0 이었다. 이 함수는 fopt(mid)와 resource 의 acpi
 * 검증이 계속 쓴다. 아래 시험은 그 두 호출부의 계약이다.
 */
'use strict';
