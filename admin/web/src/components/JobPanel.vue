...
/** With any failure the job is not shown green, even when complete. */
const tone = computed(() => {
...
<template>
  <div class="job" :class="tone">
    ...
    <!-- Skip reasons are evidence. Without an answer to 'why were only 3 deleted', the administrator cannot trust the list. -->
