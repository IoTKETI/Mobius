...
/**
 * Shows this server's ACP operating principles and policy on the screen.
 *
 * The source is docs/superpowers/specs/2026-08-29-acp-operating-model.md, and every figure in the table comes from that document. No wording is invented here; when screen and document disagree, neither can be trusted.
 *
 * Always visible are the principles and 'the default policy is replaced'; the rest (templates, bit table, pitfalls) is collapsed.
 */
