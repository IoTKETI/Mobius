...
async function load() {
  ...
  error.value = ''
  try {
    // The two look at different things: the body check asks whether the ACP itself is sound, the reference check whether what points at it is sound. Either alone cannot answer 'why does it not apply'.
