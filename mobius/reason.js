...
var REASON = {
    ...
    '400-5': { code: RSC.BAD_REQUEST, msg: "BAD REQUEST: [parse_to_json] do not parse xml body" },
    '400-6': { code: RSC.BAD_REQUEST, msg: "BAD REQUEST: [parse_to_json] do not parse cbor body" },
    '400-7': { code: RSC.BAD_REQUEST, msg: "BAD REQUEST: [parse_to_json] root tag of body is not matched" },
    ...
    '400-19': { code: RSC.BAD_REQUEST, msg: "BAD REQUEST: [check_notification] post request without ty value is but body is not for notification" },
    '400-20': { code: RSC.BAD_REQUEST, msg: "BAD REQUEST: [check_notification] content-type is none" },
    ...
    '403-5': { code: RSC.AE_NOT_ALLOWED, msg: "[app.use] ACCESS DENIED (fopt)" },
    ...
    '409-6': { code: RSC.AEI_DUPLICATED, msg: "[create_action] aei is duplicated" },
    ...
    '500-4': { code: RSC.INTERNAL_SERVER_ERROR, msg: "[create_action] create resource error" },
