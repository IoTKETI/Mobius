'use strict';
// Compares two snapshots; used for both the static (table-*.json) and the runtime (runtime-*.json) kind.
//
//   node tools/response-golden/compare.js out/table-before.json out/table-after.json
//
// Exit 0 without differences; otherwise the differences are printed and the exit code is 1. The purpose is the list of differences, not a pass; whether a difference is intended is a human judgement.
